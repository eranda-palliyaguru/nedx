...
<script type="text/javascript">
 ...
 <div class="content-wrapper">
   ...
   <thead></thead>
               <tbody>
 <?php	 $id=$_GET['id'];
 $result1 = $db->prepare("SELECT * FROM pick_order  WHERE id='$id'  ");
   ...
   <tr><th>Pick Plase</th><td><?php echo $row1['pick_name'];?></td></tr>
      <tr><th>Bill amount</th><td><?php echo $row1['amount'];?></td></tr>
 ...
 <form method="post" action="deliver_save.php">
 <div class="box-body">
         <div class="row">
           <div class="col-md-3">
       </div>
       <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">
       <input class="btn btn-info" type="submit" value="Delivered" >
